...
1. Sign in to your RingCentral account in the extension, and select the Zoho platform. Make sure to click the "Connect" button.
    [Sign in and select Zoho](../img/ringclone-zoho-signin-and-select.png)

2. A window will be opened prompting you to login to your Zoho account. Authorize Zoho and click "Accept".
    [Authorize Zoho](../img/ringclone-zoho-accept.png)

When you login successfully, the Chrome extension will automatically update to show you are connected to Zoho. If you are connected, the button next to Bullhorn will say "logout".
