...
function getDeveloperCipherKey(): string {
...
function decode(encryptedData: string): string {
...
const ConnectorWithProxyConfig = Connector as any;
ConnectorWithProxyConfig.getProxyConfig = async (proxyId: string) => {
