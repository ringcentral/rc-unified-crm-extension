...
const moment = /** @type {any} */ (require('moment-timezone'));
 ...
 * @param {{ message: any, user: any }} params - SMS time-entry inputs
 ...
 */
async function uploadImageToClio({ user, authHeader, imageDownloadLink, imageContentType, message, contactInfo, additionalSubmission, messageSubject, logBody = undefined }) {
