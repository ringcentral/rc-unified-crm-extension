...
async function createSpreadsheetWithHeaders({ accessToken, newSheetName }) {
    ...
    try {
        ...
        const requestCallLogHeaderData = ["ID", "Sheet Id", "Subject", "Contact name", "Notes", "Phone", "Start time", "End time", "Duration", "Session Id", "Direction", "Call Result", "Call Recording","Incoming Phone Number","Outgoing Phone Number"];
